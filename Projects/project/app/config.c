...
#if defined PANEL
#if defined PANEL_TEST // 产测面板,第一个按键为"总开关"
static uint8_t DEF_DEFAULT_CONFIG[40] = {0xF2, 0x01, 0x0E, 0x0E, 0x0E, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x21, 0x21, 0x21, 0x21, 0x00, 0x00, 0x00,
